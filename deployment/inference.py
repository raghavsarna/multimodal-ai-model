...
class VideoUtteranceProcessor:
    ...
    def extract_segment(self, video_path, start_time, end_time, temp_dir="/tmp"):
        ...
        segment_path = os.path.join(temp_dir, "segment_{start_time}_{end_time}.mp4")
...
def model_fn(model_dir):
    ...
    if not install_ffmpeg():
        raise RuntimeError("Failed to install FFmpeg which is needed for inference")
...
def predict_fn(input_data, model_dict):
    ...
    for segment in result["segments"]:
        try:
            ...
            print("Segment failed in inference: " + str(e))
...
if __name__ == "__main__":
   process_local_video("./surprise.mp4")