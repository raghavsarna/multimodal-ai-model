...
class MELDDataset(Dataset):
    ...
    def _load_video_frames(self, video_path):
        ...
        try:
            ...
            # Reset idx to not skip first frame
    ...
    def _extract_audio_features(self, video_path):
        ...
        try:
            ...
            mel_spectrogram = torchaudio.transforms.MelSpectrogram(sample_rate=16000, n_fft=1024, n_mels=64, hop_length=512)
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            #Map sentiment and emotional labels
...
def prepare_dataloaders(train_csv, train_video_dir, dev_csv, dev_video_dir, test_csv, test_video_dir, batch_size=32):
    ...
    train_loaded = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, collate_fn=collate_fn)
    dev_loaded = DataLoader(dev_dataset, batch_size=batch_size, collate_fn=collate_fn)
    test_loaded = DataLoader(test_dataset, batch_size=batch_size, collate_fn=collate_fn)
    
    return train_loaded, dev_loaded, test_loaded
